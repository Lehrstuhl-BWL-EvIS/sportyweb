defmodule Sportyweb.Repo.Migrations.CreateContracts do
  ...
  def change do
    create table(:contracts, primary_key: false) do
      ...
      add :partner_department_id,
          references(:departments, on_delete: :delete_all, type: :binary_id),
          null: true

      add :partner_group_id, references(:groups, on_delete: :delete_all, type: :binary_id),
        null: true
