defmodule Sportyweb.LegalTest do
  ...
  describe "fees" do
    ...
    @invalid_attrs %{admission_fee_in_eur_cent: nil, base_fee_in_eur_cent: nil, commission_at: nil, decommission_at: nil, description: nil, has_admission_fee: nil, is_group_only: nil, is_recurring: nil, maximum_age_in_years: nil, minimum_age_in_years: nil, name: nil, reference_number: nil, type: nil}
    ...
    test "create_fee/1 with valid data creates a fee" do
      valid_attrs = %{admission_fee_in_eur_cent: 42, base_fee_in_eur_cent: 42, commission_at: ~D[2023-02-24], decommission_at: ~D[2023-02-24], description: "some description", has_admission_fee: true, is_group_only: true, is_recurring: true, maximum_age_in_years: 42, minimum_age_in_years: 42, name: "some name", reference_number: "some reference_number", type: "some type"}
      ...
      assert fee.has_admission_fee == true
    ...
    test "update_fee/2 with valid data updates the fee" do
      fee = fee_fixture()
      update_attrs = %{admission_fee_in_eur_cent: 43, base_fee_in_eur_cent: 43, commission_at: ~D[2023-02-25], decommission_at: ~D[2023-02-25], description: "some updated description", has_admission_fee: false, is_group_only: false, is_recurring: false, maximum_age_in_years: 43, minimum_age_in_years: 43, name: "some updated name", reference_number: "some updated reference_number", type: "some updated type"}
      ...
      assert fee.has_admission_fee == false
