defmodule SportywebWeb.CoreComponents do
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-800 font-semibold">
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "mt-2 xs:py-8 sm:py-2 block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
          @errors == [] && "border-zinc-300 focus:border-zinc-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
