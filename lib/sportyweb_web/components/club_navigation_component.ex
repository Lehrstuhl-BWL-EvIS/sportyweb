defmodule SportywebWeb.ClubNavigationComponent do
  ...
  def render(assigns) do
    default_icon_classes = "text-zinc-400 group-hover:text-zinc-500 mr-4 h-6 w-6"

    ~H"""
    <nav class="sticky top-10">
      <div class="space-y-1">
        <.link navigate={~p"/clubs/#{@club}"} class="text-zinc-700 hover:bg-zinc-50 group flex items-center px-3 py-2 text-base lg:text-sm font-medium rounded-md">
