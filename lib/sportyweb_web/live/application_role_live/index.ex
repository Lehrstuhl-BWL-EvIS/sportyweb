defmodule SportywebWeb.ApplicationRoleLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:application_role, AccessControl.get_application_role!(id))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    application_role = AccessControl.get_application_role!(id)
    {:ok, _} = AccessControl.delete_application_role(application_role)

    {:noreply, assign(socket, :applicationroles, list_applicationroles())}
  end

  defp list_applicationroles do
    AccessControl.list_applicationroles()
  end
end
