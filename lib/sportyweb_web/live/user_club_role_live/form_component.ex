defmodule SportywebWeb.UserClubRoleLive.FormComponent do
  ...
  def update(%{user_club_role: user_club_role} = assigns, socket) do
    changeset = AccessControl.change_user_club_role(user_club_role)
  ...
  def handle_event("validate", %{"user_club_role" => user_club_role_params}, socket) do
    changeset =
      ...
      |> AccessControl.change_user_club_role(user_club_role_params)
  ...
  defp save_user_club_role(socket, :edit, user_club_role_params) do
    case AccessControl.update_user_club_role(socket.assigns.user_club_role, user_club_role_params) do
      {:ok, _user_club_role} ->
        {:noreply,
         socket
  ...
  defp save_user_club_role(socket, :new, user_club_role_params) do
    case AccessControl.create_user_club_role(user_club_role_params) do
      {:ok, _user_club_role} ->
        {:noreply,
         socket
