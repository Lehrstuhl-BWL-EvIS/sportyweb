defmodule SportywebWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_sportyweb_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SportywebWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule SportywebWeb.PageLive do
        use SportywebWeb, :live_view

        on_mount {SportywebWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SportywebWeb.UserAuth, :ensure_authenticated}] do
  ...
  def require_authenticated_user(conn, _opts) do
    if conn.assigns[:current_user] do
      ...
      conn
      |> put_flash(:error, "Sie müssen angemeldet sein, um auf diese Seite zugreifen zu können.")
