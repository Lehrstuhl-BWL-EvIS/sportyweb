# Sportyweb - A web application for managing amateur sports clubs
...
```
cd existing_repo
git remote add origin https://gitlab.com/sportyweb/sportyweb.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sportyweb/sportyweb/-/settings/integrations)
